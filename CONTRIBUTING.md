...
Finally, check the open [issues and feature requests](https://github.com/nnichols/brewtility/issues) of the project and ask the maintainers if they are available to be taken on.
...
2. Update the project's [CHANGELOG.md](https://github.com/nnichols/brewtility/blob/master/CHANGELOG.md) with the new version, date of changes, and a description of the modifications made
3. If any changes impact the external interface or use of the library, please update the [README](https://github.com/nnichols/brewtility/blob/master/README.md) to reflect any relevant differences or with additional documentation.
