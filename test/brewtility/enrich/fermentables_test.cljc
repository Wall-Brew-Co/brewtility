...
(deftest enrich-fermentable-tests
  (testing "Ensure enrichment pattern functions generate conforming data"
    (is (s/valid? ::fermentable.format/fermentable
